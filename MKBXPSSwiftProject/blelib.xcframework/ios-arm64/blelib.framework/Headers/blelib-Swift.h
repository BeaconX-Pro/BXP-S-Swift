...
// Generated by Apple Swift version 6.4 effective-5.10 (swiftlang-6.4.0.30.4 clang-2100.3.30.1)
#ifndef BLELIB_SWIFT_H
#define BLELIB_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="blelib",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC6blelib15ATCommandParser")
@interface ATCommandParser : NSObject
...
@class NSXMLParser;
@class NSString;
@interface ATCommandParser (SWIFT_EXTENSION(blelib)) <NSXMLParserDelegate>
...
/// <ul>
///   <li>
///     The main entry point for SDK users. The central that wraps the
///     Android’s GATT APIs for communication and the utility functions that other
///     coupled layer will be using.
///   </li>
/// </ul>
SWIFT_CLASS("_TtC6blelib10BleManager")
@interface BleManager : NSObject <CBCentralManagerDelegate, CBPeripheralDelegate, CBPeripheralManagerDelegate>
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
