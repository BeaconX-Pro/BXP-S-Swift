//
//  MKBXSExportHTDataCurveView.swift
//  MKBXPSSwiftProject
//
...
public final class MKBXSExportHTDataCurveView: UIView {
    ...
    private lazy var humidityView: MKBXSTHCurveView = MKBXSTHCurveView()

    private lazy var humidityModel: MKBXSTHCurveViewModel = {
        let m = MKBXSTHCurveViewModel()
        m.lineColor = .green
        m.curveViewBackgroundColor = .white
        m.lineWidth = 3
        m.curveTitle = "Humidity(%RH)"
        m.labelColor = UIColor(red: 136/255.0, green: 136/255.0, blue: 136/255.0, alpha: 1)
        return m
    }()
